...
/**
 * The base implementation of the opened conversation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.marcelmika.lims.service.impl.OpenedConversationLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class OpenedConversationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements OpenedConversationLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.marcelmika.lims.service.OpenedConversationLocalServiceUtil} to access the opened conversation local service.
	 */
	...
	public OpenedConversation addOpenedConversation(
		OpenedConversation openedConversation) throws SystemException {
		openedConversation.setNew(true);

		return openedConversationPersistence.update(openedConversation, false);
	}
	 ...
	 */
	public OpenedConversation createOpenedConversation(long ocid) {
		return openedConversationPersistence.create(ocid);
	}
	...
	public OpenedConversation deleteOpenedConversation(long ocid)
		throws PortalException, SystemException {
		return openedConversationPersistence.remove(ocid);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public OpenedConversation deleteOpenedConversation(
		OpenedConversation openedConversation) throws SystemException {
		return openedConversationPersistence.remove(openedConversation);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(OpenedConversation.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return openedConversationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return openedConversationPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public OpenedConversation fetchOpenedConversation(long ocid)
		throws SystemException {
		return openedConversationPersistence.fetchByPrimaryKey(ocid);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public OpenedConversation getOpenedConversation(long ocid)
		throws PortalException, SystemException {
		return openedConversationPersistence.findByPrimaryKey(ocid);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return openedConversationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<OpenedConversation> getOpenedConversations(int start, int end)
		throws SystemException {
		return openedConversationPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getOpenedConversationsCount() throws SystemException {
		return openedConversationPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public OpenedConversation updateOpenedConversation(
		OpenedConversation openedConversation) throws SystemException {
		return updateOpenedConversation(openedConversation, true);
	}
	...
	public OpenedConversation updateOpenedConversation(
		...
		return openedConversationPersistence.update(openedConversation, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.marcelmika.lims.model.OpenedConversation",
			openedConversationLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = openedConversationPersistence.getDataSource();
	...
	private OpenedConversationLocalServiceClpInvoker _clpInvoker = new OpenedConversationLocalServiceClpInvoker();
}