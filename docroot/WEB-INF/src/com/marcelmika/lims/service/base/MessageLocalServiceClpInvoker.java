...
public class MessageLocalServiceClpInvoker {
	public MessageLocalServiceClpInvoker() {
		...
		_methodParameterTypes0 = new String[] {
				"com.marcelmika.lims.model.Message"
			};
		...
		_methodParameterTypes15 = new String[] {
				"com.marcelmika.lims.model.Message", "boolean"
			};
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return MessageLocalServiceUtil.addMessage((com.marcelmika.lims.model.Message)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return MessageLocalServiceUtil.deleteMessage((com.marcelmika.lims.model.Message)arguments[0]);
		}
		...
		if (_methodName14.equals(name) &&
			...
			return MessageLocalServiceUtil.updateMessage((com.marcelmika.lims.model.Message)arguments[0]);
		}
