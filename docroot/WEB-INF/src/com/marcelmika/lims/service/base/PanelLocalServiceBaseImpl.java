...
/**
 * The base implementation of the panel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.marcelmika.lims.service.impl.PanelLocalServiceImpl}.
 * </p>
 *
...
public abstract class PanelLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.marcelmika.lims.service.PanelLocalServiceUtil} to access the panel local service.
	 */
	...
	public Panel addPanel(Panel panel) throws SystemException {
		...
		return panelPersistence.update(panel, false);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Panel updatePanel(Panel panel, boolean merge)
		throws SystemException {
		panel.setNew(false);

		return panelPersistence.update(panel, merge);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.marcelmika.lims.model.Panel",
			panelLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.marcelmika.lims.model.Panel");
	}
